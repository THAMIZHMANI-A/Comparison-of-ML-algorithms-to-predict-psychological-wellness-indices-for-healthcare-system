...
def start(bot, update):
    ...
    langs_markup = InlineKeyboardMarkup([[
        ...
        InlineKeyboardButton('Tamil {}'.format(b'\xF0\x9F\x8C\x8D'.decode()), callback_data='ru')]])
    bot.send_message(
        text='Choose your language', reply_markup=langs_markup, chat_id=update.message.chat_id)
