...
class HARSQuiz(BaseQuiz):
    ...
    RESULTS = {
        'ru': ['கவலை இல்லாமை 👍', 'பதட்டத்தின் தீவிரத்தை லேசானது 😐', 'கவலைக் கோளாறின் மிதமான தீவிரம் 😦'],
...
class MADRSQuiz(BaseQuiz):
    ...
    RESULTS = {
        ...
        'ru': ['விதிமுறை 👍', 'லேசான மனச்சோர்வு 😐', 'மிதமான மனச்சோர்வு 😔', 'கடுமையான மனச்சோர்வு 😨']}
    ...
    def get_result(self):
        ...
        return '{}:\n{}/{}\n{}'.format(
            'விளைவாக' if self.lang == 'ru' else 'Result',
